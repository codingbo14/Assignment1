Feature: Techfios Other billing login page functionality validation
  ...
  Scenario Outline: User should be able to login with valid credentials
    ...
    Examples: 
      | username          | password | accountTitle | description | initialBalanc | accountNumber | contactPerson | Phone               | internetBankingURL |
      | demo@techfios.com | abc123   | loan         | mortgage    |     2000,0000 |      67543289 | James         | https://www.pnc.com |                    |
